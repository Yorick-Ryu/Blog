...
![点击状态栏](./img/image (1).png)

​	下滑找到**时间**

![下滑找到时间](./img/image (2).png)

选中**显示小时、分钟和秒**

![选择显示小时、分钟和秒](./img/image (3).png)
...
| NetworkState | [点击此处](https://yorick.love/file/NetworkState.apk)        | 锁屏段    |
...
![扫码每日领红包！](./img/1667366441949__01.jpg)
